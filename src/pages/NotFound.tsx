  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-100 dark:bg-slate-950">
      <div className="text-center">
        ...
        <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100 mt-2">Page not found</h1>
        <p className="text-slate-500 dark:text-slate-400 mt-1 mb-6">The page you're looking for doesn't exist.</p>
